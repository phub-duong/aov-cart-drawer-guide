...
3. Under **Layout & Icon**, select a layout:
...
4. Choose the **Position** — **Left** or **Right** side of the screen.
5. Select an **Icon** that appears on the button (cart, bag, or other options).
6. (Optional) Enter **Button text** to display a label next to the icon.
...
7. Under **Style & Spacing**, fine-tune the button's appearance:
...
8. Set the colors for the sticky cart button:
...
9. Under **Advanced settings**, configure behavior:
...
10. Click **Preview** to see how the sticky cart button looks on your store.
11. Once satisfied, click **Save** to apply your settings.
