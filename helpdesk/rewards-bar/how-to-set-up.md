...
4. Under **Tiers**, configure each tier:
...
5. Click **Add tier** to create additional reward levels.
6. (Optional) Configure **Threshold by currency** if you sell in multiple currencies, and use **Local currency conversion** for automatic conversions.
...
7. Under **Display setting** > **Content**, customize the text customers see:
...
8. Under **Display setting** > **Style**, set the visual appearance:
...
10. Click **Preview** to see the rewards bar in action within the cart drawer.
