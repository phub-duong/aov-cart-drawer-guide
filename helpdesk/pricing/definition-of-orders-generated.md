...
On the **Free plan**, you have a limit of 50 orders per month processed through the cart drawer. Understanding what counts helps you estimate whether the Free plan is sufficient for your store's traffic.

> **Tip:** If most of your customers use the cart drawer (which is the default behavior once enabled), most orders will count toward your quota. Consider upgrading to a paid plan if you consistently approach the 50-order limit.

## Related

- [Pricing Plan](pricing-plan.md)
- [Quota Usage for Free Plan](quota-usage-for-free-plan.md)
